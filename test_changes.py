...
from backend.computer_use.tools import execute_terminal_command, pretty_print_execute_terminal_results
...
def test_terminal_execution():
    """Test the terminal command execution tool."""
    ...
    print("\nFormatted output:")
    print(pretty_print_execute_terminal_results(result))
    print("Terminal command execution test completed.\n")
